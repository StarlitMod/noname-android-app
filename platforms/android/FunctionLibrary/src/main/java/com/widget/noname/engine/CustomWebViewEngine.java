 ...
 */
public class CustomWebViewEngine implements CordovaWebViewEngine {
    public static final String TAG = "CustomWebViewEngine";

    protected final CustomWebView webView;
    protected final CustomCookieManager cookieManager;
    ...
    public CustomWebViewEngine(CustomWebView webView, CordovaPreferences preferences) {
        this.preferences = preferences;
        this.webView = webView;
        cookieManager = new CustomCookieManager(webView);
    }
    ...
    public void init(CordovaWebView parentWebView, CordovaInterface cordova, Client client,
        ...
        nativeToJsMessageQueue.addBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
            ...
            public void runOnUiThread(Runnable r) {
                CustomWebViewEngine.this.cordova.getActivity().runOnUiThread(r);
            }
        }));
    ...
    private static void exposeJsInterface(WebView webView, CordovaBridge bridge) {
        CustomExposedJsApi exposedJsApi = new CustomExposedJsApi(bridge);
