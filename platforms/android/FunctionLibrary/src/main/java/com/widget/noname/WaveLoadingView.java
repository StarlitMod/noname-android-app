...
public class WaveLoadingView extends View {
    ...
    private static final int DEFAULT_WAVE_BACKGROUND_COLOR = Color.parseColor("#484848");
    ...
    private static final int DEFAULT_BORDER_SHADOW_COLOR = Color.parseColor("#33000000");
    ...
    private static final float DEFAULT_TITLE_CENTER_SIZE = 30f;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Init AmplitudeRatio
        mAmplitudeRatio = DEFAULT_AMPLITUDE_VALUE / 1000;
        ...
        mBorderPaint.setShadowLayer(4, 0,0, DEFAULT_BORDER_SHADOW_COLOR);
