...
public class CustomWebChromeClient extends WebChromeClient {
    ...
    protected final CustomWebViewEngine parentEngine;
    ...
    public CustomWebChromeClient(CustomWebViewEngine parentEngine) {
        this.parentEngine = parentEngine;
        appContext = parentEngine.webView.getContext();
        dialogsHelper = new DialogsHelper(appContext);
    }
    ...
    public boolean onJsAlert(WebView view, String url, String message, final JsResult result) {
        dialogsHelper.showAlert(message, new DialogsHelper.Result() {
    ...
    public boolean onJsConfirm(WebView view, String url, String message, final JsResult result) {
        dialogsHelper.showConfirm(message, new DialogsHelper.Result() {
            @Override
    ...
    public boolean onJsPrompt(WebView view, String origin, String message, String defaultValue, final JsPromptResult result) {
        ...
        if (handledRet != null) {
            ...
            dialogsHelper.showPrompt(message, defaultValue, new DialogsHelper.Result() {
                @Override
                public void gotResult(boolean success, String value) {
                    if (success) {
