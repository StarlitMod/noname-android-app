package com.widget.noname.function.functionserver;

import android.util.Log;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.widget.noname.function.functionserver.pojo.Config;
import com.widget.noname.function.functionserver.pojo.Event;
import com.widget.noname.function.functionserver.pojo.Room;
import com.widget.noname.function.functionserver.util.ServerUtil;
import com.widget.noname.function.functionserver.util.Util;
...
public class NonameWebSocketServer extends WebSocketServer {
    ...
    public void onMessage(WebSocket conn, String message) {
        ...
        if (null != ws) {
            ...
            conn.close();
            Log.e(TAG, "unknown client, close." + wsid);
        }
    }
    ...
    private void updateClients() {
        ...
        for (String key : clientsKeys) {
            ...
            if (ws != null) {
                Log.e(TAG, "updateClients" + ws.toString());
            }
