package com.widget.noname.function.functionserver.util;

import com.alibaba.fastjson.JSONArray;
import com.widget.noname.function.functionserver.WebSocketClient;
...
public class Util {
    private static final String NICK_NAME_NONAME = "无名玩家";
