...
function constructOriginTrialTree(originTrial) {
    ...
    <li role="treeitem">
      ...
      ${createBadge({
        ...
        style: originTrial.status === "Enabled" /* Protocol.Page.OriginTrialStatus.Enabled */ ? 'success' : 'error',
    })}
...
function constructTokenNode(token) {
    const statusBadge = createBadge({
        ...
        style: token.status === "Success" /* Protocol.Page.OriginTrialTokenStatus.Success */ ? 'success' : 'error',
