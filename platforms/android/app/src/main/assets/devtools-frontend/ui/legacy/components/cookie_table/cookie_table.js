import"../data_grid/data_grid.js";import*as e from"../../../../core/common/common.js";import*as t from"../../../../core/i18n/i18n.js";import*as i from"../../../../core/root/root.js";import*as o from"../../../../core/sdk/sdk.js";import*as s from"../../../../models/issues_manager/issues_manager.js";import*as a from"../../../../panels/network/forward/forward.js";import*as n from"../../../components/icon_button/icon_button.js";import{Directives as r,render as l,html as d}from"../../../lit/lit.js";import*as h from"../../legacy.js";var c=`devtools-data-grid{flex:auto}.cookies-table devtools-icon{margin-right:4px}\n/*# sourceURL=${import.meta.resolve("./cookiesTable.css")} */`;const{repeat:p,ifDefined:u}=r,m={session:"Session",name:"Name",value:"Value",size:"Size",domain:"Domain",path:"Path",secure:"Secure",partitionKeySite:"Partition Key Site",priority:"Priority",editableCookies:"Editable Cookies",cookies:"Cookies",na:"N/A",showRequestsWithThisCookie:"Show requests with this cookie",showIssueAssociatedWithThis:"Show issue associated with this cookie",sourcePortTooltip:"Shows the source port (range 1-65535) the cookie was set on. If the port is unknown, this shows -1.",sourceSchemeTooltip:"Shows the source scheme (`Secure`, `NonSecure`) the cookie was set on. If the scheme is unknown, this shows `Unset`.",timeAfter:"after {date}",timeAfterTooltip:"The expiration timestamp is {seconds}, which corresponds to a date after {date}",opaquePartitionKey:"(opaque)"},b=t.i18n.registerUIStrings("ui/legacy/components/cookie_table/CookiesTable.ts",m),k=t.i18n.getLocalizedString.bind(void 0,b),g=t.i18n.getLazilyComputedLocalizedString.bind(void 0,b)(m.session);class $ extends h.Widget.VBox{saveCallback;refreshCallback;selectedCallback;deleteCallback;lastEditedColumnId;data=[];cookies=[];cookieDomain;cookieToBlockedReasons;cookieToExemptionReason;view;selectedKey;editable;renderInline;schemeBindingEnabled;portBindingEnabled;constructor(e,t,o,s,a,n){super(),n||(n=(e,t,i)=>{l(d`
          ...
          >
            <table>
              ...
              ${p(this.data,e=>e.key,t=>d`
                <tr ?selected=${t.key===e.selectedKey}
                    ?inactive=${t.inactive}
                    ?dirty=${t.dirty}
                    ?highlighted=${t.flagged}
                    @edit=${i=>e.onEdit(t,i.detail.columnId,i.detail.valueBeforeEditing,i.detail.newText)}
                    @delete=${()=>e.onDelete(t)}
                    @contextmenu=${i=>e.onContextMenu(t,i.detail)}
                    @select=${()=>e.onSelect(t.key)}>
